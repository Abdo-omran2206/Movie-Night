    ...
    <main className="min-h-screen bg-black text-white pt-32 pb-20 px-4 md:px-10 lg:px-20">
      <div className="container mx-auto">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-10 mb-16">
              {movies.map((movie) => (
            ...
            <div className="flex items-center justify-center gap-6 mt-12">
              ...
              <div className="flex items-center gap-2">
                <span className="text-red-600 font-bold text-lg">{page}</span>
